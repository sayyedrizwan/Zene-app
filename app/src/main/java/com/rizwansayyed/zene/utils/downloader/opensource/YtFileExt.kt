package com.rizwansayyed.zene.utils.downloader.opensource
...
fun SparseArray<YtFile>.getVideoOnly(): ArrayList<YtFile> {
    val resultList: ArrayList<YtFile> = ArrayList()
    val listVideoItag = listOf(18,22,37,38,82,83,84,85,133,134,135,136,137,138,160,242,243,244,247,248,264,266,271,272,278,298,299,302,303,308,313,315,330,331,332,333,334,335,336,337,394,395,396,397,398,399,400,401,402,403,404,405,406,407,408,409,410)
