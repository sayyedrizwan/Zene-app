...
object URLSUtils {
    ...
    const val ZENE_CONNECT_FRIENDS_API = "connect/connect-friends"
    ...
    const val ZENE_CONNECT_SEND_LOCATION_API = "connect/connect-send-location"
    const val ZENE_CONNECT_SHARE_VIBE_API = "connect/connect-share-vibe"
