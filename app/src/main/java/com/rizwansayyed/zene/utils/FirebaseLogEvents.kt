...
object FirebaseLogEvents {
    ...
    enum class FirebaseEvents {
        ...
        RECEIVED_NOTIFICATION, STARTED_PLAYING_SONG, STARTED_PLAYING_RADIO, UPDATED_PLAYBACK_SPEED, TO_NEXT_SONG,
        TO_PREVIOUS_SONG, TAP_PLAYING, TAP_PAUSE, VIEWED_ARTISTS, MY_MUSIC_PERSONAL_PLAYLISTS,
        MY_MUSIC_OFFLINE_SONGS, MY_MUSIC_SONG_HISTORY, STARTED_FOLLOWING, STOP_FOLLOWING, STARTED_ARTISTS_RADIO,
        ...
        OPEN_SONG_SHEET, NAVIGATION_DATA, OPEN_SHARE_APP, APP_LANGUAGE, CLICK_ADS_VIEWED_PAGE,
        OPEN_ZENE_WEB_APP_FROM_APP, OPEN_ZENE_WALLZ, UPDATE_AVAILABLE_CARD_CLICKED,
        OPEN_SLEEP_TIMER, OPEN_WAKE_TIMER, EMAIL_SIGN_IN,
        EARPHONE_TRACKER
    }
