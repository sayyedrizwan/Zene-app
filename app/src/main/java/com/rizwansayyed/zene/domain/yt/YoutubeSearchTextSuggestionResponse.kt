...
data class YoutubeSearchTextSuggestionResponse(
    ...
    data class Content(
        ...
        data class SearchSuggestionsSectionRenderer(
            ...
            data class Content(
                val musicResponsiveListItemRenderer: MusicResponsiveListItemRendererSearchText?,
...
data class MusicResponsiveListItemFlexColumnRendererSearchTxt(
...
data class MenuNavigationItemRendererSearchText(
    val icon: Icon?,
    val navigationEndpoint: NavigationEndpoint?,
    val text: Text?,
    val trackingParams: String?
...
data class QueueAddEndpointSearchText(
...
data class MusicResponsiveListItemRendererSearchText(
    ...
    data class FlexColumn(
        val musicResponsiveListItemFlexColumnRenderer: MusicResponsiveListItemFlexColumnRendererSearchTxt?
    )
    ...
    data class Menu(
        ...
        data class MenuRenderer(
            ...
            data class Item(
                val menuNavigationItemRenderer: MenuNavigationItemRendererSearchText?,
                ...
                data class MenuServiceItemRenderer(
                    ...
                    data class ServiceEndpoint(
                        val clickTrackingParams: String?,
                        val queueAddEndpoint: QueueAddEndpointSearchText?
                    )
