                        ...
                        data class SectionListRenderer(
                            ...
                            data class Content(
                                ...
                                data class MusicCarouselShelfRenderer(
                                    ...
                                    data class Content(
                                        val musicTwoRowItemRenderer: MusicTwoRowItemRendererPlaylist?
                                    )
...
data class MusicTwoRowItemRendererPlaylist(
    val aspectRatio: String?,
    val menu: Menu?,
    val navigationEndpoint: NavigationEndpointPlaylistAlbum?,
    val subtitle: Subtitle?,
    ...
    data class Menu(
        ...
        data class MenuRenderer(
            ...
            data class Item(
                val menuNavigationItemRenderer: MusicResponsiveListItemRenderer.Menu.MenuRenderer.Item.MenuNavigationItemRenderer?,
                val menuServiceItemRenderer: MenuServiceItemRenderer?,
    ...
    data class NavigationEndpointPlaylistAlbum(
        val browseEndpoint: BrowseEndpoint?,
        val clickTrackingParams: String?
    ) {
        data class BrowseEndpoint(
