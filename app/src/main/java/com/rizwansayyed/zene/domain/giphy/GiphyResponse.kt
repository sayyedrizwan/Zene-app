...
data class GiphyResponse(
    ...
    data class Data(
        val alt_text: String?,
        val alt_text_author: AltTextAuthor?,
        ...
        val featured_tags: List<String?>?,
        val has_attribution: Boolean?,
        val id: String?,
        val images: Images?,
        val import_datetime: String?,
        val index_id: Int?,
        val is_anonymous: Int?,
        val is_community: Int?,
        val is_featured: Int?,
        val is_hidden: Int?,
        val is_realtime: Int?,
        val is_removed: Int?,
        ...
        data class User(
            val attribution_display_name: String?,
            ...
            val suppress_chrome: Boolean?,
            val tumblr_url: String?,
            val twitter: String?,
            val twitter_url: String?,
            val user_type: String?,
            val username: String?,
            val website_display_url: String?,
