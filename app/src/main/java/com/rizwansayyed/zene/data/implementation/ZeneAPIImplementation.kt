...
class ZeneAPIImplementation @Inject constructor(
    ...
    override suspend fun entBuzzNews() = flow {
        val email = userInfo.firstOrNull()?.email ?: ""
        val token = userInfo.firstOrNull()?.authToken ?: ""
        ...
        val body = json.toString().toRequestBody("application/json".toMediaTypeOrNull())
        emit(zeneAPI.entBuzzNews(token, body))
    }

    override suspend fun entDiscoverLifeStyle() = flow {
        val email = userInfo.firstOrNull()?.email ?: ""
        val token = userInfo.firstOrNull()?.authToken ?: ""
        ...
        val body = json.toString().toRequestBody("application/json".toMediaTypeOrNull())
        emit(zeneAPI.entDiscoverLifeStyle(token, body))
    }
    ...
    override suspend fun entStreamingTrending() = flow {
        val email = userInfo.firstOrNull()?.email ?: ""
        val token = userInfo.firstOrNull()?.authToken ?: ""
        val country = ipDB.firstOrNull()?.countryCode
        ...
        val body = json.toString().toRequestBody("application/json".toMediaTypeOrNull())
        emit(zeneAPI.entStreamingTrending(token, body))
    }


    override suspend fun entBoxOfficeMovie() = flow {
        val email = userInfo.firstOrNull()?.email ?: ""
        val token = userInfo.firstOrNull()?.authToken ?: ""
        ...
        val body = json.toString().toRequestBody("application/json".toMediaTypeOrNull())
        emit(zeneAPI.entBoxOfficeMovie(token, body))
    }

    override suspend fun entUpcomingMovie() = flow {
        val email = userInfo.firstOrNull()?.email ?: ""
        val token = userInfo.firstOrNull()?.authToken ?: ""
        val country = ipDB.firstOrNull()?.countryCode
    ...
    override suspend fun entLifestyleEventsInfo(id: String) = flow {
        val email = userInfo.firstOrNull()?.email ?: ""
        val token = userInfo.firstOrNull()?.authToken ?: ""
        ...
        val body = json.toString().toRequestBody("application/json".toMediaTypeOrNull())
        emit(zeneAPI.entLifestyleEventsInfo(token, body))
    }
